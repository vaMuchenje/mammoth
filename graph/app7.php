...
//https://shkspr.mobi/blog/2013/04/extracting-your-data-from-the-audioboo-api/
...
//https://api.audioboom.com/channels/4617363/audio_clips
    /*
    https://audioboom.com/channel/nfl
https://api.audioboom.com/channels/4617363/
https://audioboom.com/channels/4617363.rss
*/

//$AudioBooAPIresponse = file_get_contents("https://api.audioboom.com/channels/4617363/audio_clips");
$AudioBooAPIresponse = file_get_contents("https://api.audioboom.com/channels/4617363/audio_clips?page[items]=5");
...
foreach ($AudioClips as $key) 
{
	...
	//$formatted_description = $key["formatted_description"]; ///
...
//	$original     = $key["urls"]["detail"];
	...
	$mp3          = $key["urls"]["high_mp3"];
	$logo_image   = $key["channel"]["urls"]["logo_image"]["original"];
...
//	$mp3_filesize = $key["mp3_filesize"];
	...
	//echo 'ID: (' . $id . ') AND TITLE: <strong>' . $title . '</strong> (' . $username . ')<br>';
	echo '<img class="thumbnail" src="' . $logo_image . '" alt="" height="60" width="60"/>';
	echo 'ID: (' . $id . ') AND TITLE: <strong>' . $title . '</strong> (' . $username . ')<br> -'. $description . '<br><i>(' . $mp3 . ')</i><br><br>';
